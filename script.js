...
const translations = {
  en: {
    ...
    revenueAffiliateText: "Tours, transfers and experiences — proven on",
    revenueAffiliateTail: ", the network flagship.",
    ...
    revenueProof: "The flagship already runs a working affiliate attribution system — this domain is ready for the same engine.",
    ...
    seoContextTitle: "AskParos.ai is a Paros AI assistant",
    seoContextText: "Use this Paros travel guide AI for things to do in Paros, Paros beaches like Kolymbithres, Santa Maria and Golden Beach, the Antiparos day trip and cave, Paros ferry and port questions, Naousa and Parikia plans, Lefkes and the marble villages, windsurfing in Paros, food, transport and local experiences. AskParos.ai works as an AI travel planner for Greece focused on practical Paros questions.",
  ...
  el: {
    ...
    revenueAffiliateText: "Εκδρομές, μεταφορές και εμπειρίες — αποδεδειγμένο στο",
    revenueAffiliateTail: ", τη ναυαρχίδα του δικτύου.",
    ...
    revenueProof: "Η ναυαρχίδα λειτουργεί ήδη ένα ενεργό σύστημα απόδοσης προμηθειών (affiliate attribution) — αυτό το domain είναι έτοιμο για την ίδια μηχανή.",
    conciergeEyebrow: "Concierge",
    ...
    seoContextTitle: "Το AskParos.ai είναι ένας AI βοηθός για την Πάρο",
    seoContextText: "Χρησιμοποίησε αυτόν τον AI ταξιδιωτικό οδηγό για την Πάρο: τι να κάνεις στην Πάρο, παραλίες όπως Κολυμπήθρες, Σάντα Μαρία και Χρυσή Ακτή, ημερήσια εκδρομή και σπήλαιο στην Αντίπαρο, ερωτήσεις για πλοία και λιμάνι, σχέδια για Νάουσα και Παροικιά, Λεύκες και τα μαρμάρινα χωριά, windsurf στην Πάρο, φαγητό, μετακινήσεις και τοπικές εμπειρίες. Το AskParos.ai λειτουργεί ως AI ταξιδιωτικός βοηθός για την Ελλάδα με πρακτικές απαντήσεις για την Πάρο.",
